        ...
        <CardContent className="space-y-4">
          ...
          <ScrollArea className="h-96 w-full border rounded-md p-4 bg-gray-50">
            <div className="space-y-4 text-sm text-gray-700 pr-4">
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">1. PARTES CONTRATANTES E NATUREZA DO SERVIÇO</h4>
                <p className="mb-2">
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">2. OBJETO DO CONTRATO: EXECUÇÃO TÉCNICA DE MANDATO</h4>
                <p className="mb-2">
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">3. DESTINAÇÃO DO CAPITAL E EXONERAÇÃO DE RESPONSABILIDADE</h4>
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">4. SERVIÇOS PRESTADOS: O DIFERENCIAL OPERACIONAL</h4>
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">5. POLÍTICA DE SALDO, MOVIMENTAÇÃO E SAQUES</h4>
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">6. OBRIGAÇÕES DAS PARTES</h4>
                <table className="w-full text-left border-collapse mb-4">
                  <thead>
                    <tr>
              ...
              <div>
                <h4 className="font-semibold text-base mb-2">7. VIGÊNCIA, RESCISÃO E FORO</h4>
